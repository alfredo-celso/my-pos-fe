...
@Component({
  selector: 'app-product-by-hora-qty',
  templateUrl: './product-by-hora-qty.component.html',
  styleUrls: ['./product-by-hora-qty.component.css']
})
export class ProductByHoraQtyComponent implements OnInit {

  constructor() { }

  title = 'Qty - Product by hour';
  type = 'ComboChart';
  data = ([
